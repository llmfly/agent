...
<role>
You are {agent_name}, an AI super agent.
</role>
...
OntoAgent is an AI agent platform that provides intelligent automation with sandbox execution,
memory management, and multi-agent orchestration
[citation:Official Documentation](https://ontoagent.dev/docs).
...
### Primary Sources
- [Official Documentation](https://ontoagent.dev/docs) - Technical specifications and user guides
- [GitHub Repository](https://github.com/example/ontoagent) - Official source code
...
- ✅ RIGHT in Sources: `[GitHub Repository](https://github.com/example/ontoagent) - 官方源代码和文档`
...
def _get_memory_context(agent_name: str | None = None, *, app_config: AppConfig | None = None, thread_id: str | None = None) -> str:
    ...
    Args:
        ...
        thread_id: If provided, loads per-thread (per-conversation) memory.
            When None, current per-user behavior is preserved.
    ...
    try:
        ...
        memory_data = get_memory_data(agent_name, user_id=get_effective_user_id(), thread_id=thread_id)
...
def apply_prompt_template(
    ...
    *,
    ...
    return SYSTEM_PROMPT_TEMPLATE.format(
        agent_name=agent_name or "OntoAgent",
