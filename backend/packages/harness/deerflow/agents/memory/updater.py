...
def _save_memory_to_file(memory_data: dict[str, Any], agent_name: str | None = None, *, user_id: str | None = None, thread_id: str | None = None) -> bool:
    """Backward-compatible wrapper around the configured memory storage save path."""
    return get_memory_storage().save(memory_data, agent_name, user_id=user_id, thread_id=thread_id)


def get_memory_data(agent_name: str | None = None, *, user_id: str | None = None, thread_id: str | None = None) -> dict[str, Any]:
    """Get the current memory data via storage provider."""
    return get_memory_storage().load(agent_name, user_id=user_id, thread_id=thread_id)


def reload_memory_data(agent_name: str | None = None, *, user_id: str | None = None, thread_id: str | None = None) -> dict[str, Any]:
    """Reload memory data via storage provider."""
    return get_memory_storage().reload(agent_name, user_id=user_id, thread_id=thread_id)


def import_memory_data(memory_data: dict[str, Any], agent_name: str | None = None, *, user_id: str | None = None, thread_id: str | None = None) -> dict[str, Any]:
    ...
    Args:
        ...
        thread_id: If provided, scopes memory to a specific thread (conversation).
    ...
    if not storage.save(memory_data, agent_name, user_id=user_id, thread_id=thread_id):
        raise OSError("Failed to save imported memory data")
    return storage.load(agent_name, user_id=user_id, thread_id=thread_id)


def clear_memory_data(agent_name: str | None = None, *, user_id: str | None = None, thread_id: str | None = None) -> dict[str, Any]:
    """Clear all stored memory data and persist an empty structure."""
    cleared_memory = create_empty_memory()
    if not _save_memory_to_file(cleared_memory, agent_name, user_id=user_id, thread_id=thread_id):
...
def create_memory_fact(
    ...
    *,
    ...
    now = utc_now_iso_z()
    memory_data = get_memory_data(agent_name, user_id=user_id, thread_id=thread_id)
    ...
    if not _save_memory_to_file(updated_memory, agent_name, user_id=user_id, thread_id=thread_id):
        raise OSError("Failed to save memory data after creating fact")

    return updated_memory


def delete_memory_fact(fact_id: str, agent_name: str | None = None, *, user_id: str | None = None, thread_id: str | None = None) -> dict[str, Any]:
...
class MemoryUpdater:
    ...
    def _prepare_update_prompt(
        ...
        current_memory = get_memory_data(agent_name, user_id=user_id, thread_id=thread_id)
    ...
    def _finalize_update(
        ...
        return get_memory_storage().save(updated_memory, agent_name, user_id=user_id, thread_id=thread_id)
