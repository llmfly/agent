...
export function useThreadStream({
  ...
  const sendMessage = useCallback(
    async (
      ...
      const selectedMode = context.mode ?? "flash";
        ...
        await thread.submit(
          ...
          },
          {
            ...
            context: {
              ...
              ...context,
              mode: selectedMode,
              thinking_enabled: selectedMode !== "flash",
              is_plan_mode: selectedMode === "pro" || selectedMode === "ultra",
              subagent_enabled: selectedMode === "ultra",
              reasoning_effort:
