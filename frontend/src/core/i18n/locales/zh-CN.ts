...
export const zhCN: Translations = {
  ...
  welcome: {
    greeting: "你好，欢迎回来！",
    description:
      "欢迎使用 OntoAgent，你的 AI 数据智能体。让数据不仅可用，更加可信！\n通过内置和自定义的 Skills，OntoAgent 可以帮你\n探查数据、治理数据、分析数据和本体建模等。",

    createYourOwnSkill: "创建你自己的 Agent SKill",
    createYourOwnSkillDescription:
      "创建你的 Agent Skill 来释放 OntoAgent 的潜力。通过自定义技能，OntoAgent\n可以帮你搜索网络、分析数据，还能为你生成幻灯片、\n网页等作品，几乎可以做任何事情。",
  },
  ...
  inputBox: {
    ...
    suggestions: [
      {
        suggestion: "探查数据",
        prompt: "探查数据源并生成数据概况报告。",
        icon: PenLineIcon,
      },
      {
        suggestion: "治理数据",
        prompt: "对数据进行质量校验和标准化治理。",
        icon: MicroscopeIcon,
      },
      {
        suggestion: "分析数据",
        prompt: "深入分析[主题]数据，并总结发现。",
        icon: ShapesIcon,
      },
      {
        suggestion: "本体建模",
        prompt: "为[领域]构建知识本体模型。",
  ...
  dataAssets: {
    title: "数据资产",
    description: "创建和管理你的数据源 — 数据库、API 等。",
    newDataSource: "新建数据源",
    emptyTitle: "还没有数据源",
    emptyDescription: "连接你的第一个数据源，开始探索和分析数据。",
    searchPlaceholder: "搜索数据源...",
    filterAll: "全部类型",
    deleteConfirm: "确定要删除这个数据源吗？此操作不可撤销。",
    ...
    descriptionLabel: "描述",
    descriptionPlaceholder: "可选的数据源描述",
    type: "类型",
    host: "主机地址",
    port: "端口",
    username: "用户名",
    ...
    database: "数据库",
    ssl: "使用 SSL",
    attachedConversations: "关联的对话",
    attach: "关联",
    detach: "解除关联",
    alias: "别名",
    aliasPlaceholder: "Agent 可见的可选别名",
    noAttachedConversations: "暂无关联的对话",
    types: {
      mysql: "MySQL",
  ...
  agents: {
    ...
    saving: "正在保存智能体...",
    saveRequested:
      "已提交保存请求，OntoAgent 正在根据当前对话生成并保存初版智能体。",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "智能体已创建，但 OntoAgent 暂时还无法读取到它。请稍后刷新当前页面。",
    more: "更多操作",
    agentCreated: "智能体已创建！",
    startChatting: "开始对话",
  ...
  // Workspace
  workspace: {
    officialWebsite: "访问 OntoAgent 官方网站",
    githubTooltip: "访问 OntoAgent 的 Github 仓库",
    settingsAndMore: "设置",
    visitGithub: "在 Github 上查看 OntoAgent",
    reportIssue: "报告问题",
    contactUs: "联系我们",
    about: "关于 OntoAgent",
    logout: "退出登录",
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "安装技能并使其可在 OntoAgent 中使用",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription: "使用键盘快捷键更快地操作 OntoAgent。",
  ...
  settings: {
    title: "设置",
    description: "根据你的偏好调整 OntoAgent 的界面和行为。",
    sections: {
      account: "账号",
      appearance: "外观",
      memory: "记忆",
    ...
    memory: {
      title: "记忆",
      description:
        "OntoAgent 会在后台不断从你的对话中自动学习。这些记忆能帮助 OntoAgent 更好地理解你，并提供更个性化的体验。",
      empty: "暂无可展示的记忆数据。",
      rawJson: "原始 JSON",
      exportButton: "导出记忆",
      exportSuccess: "记忆已导出",
    ...
    appearance: {
      ...
      tokenTitle: "Token 用量",
      tokenDescription: "控制对话中 token 用量信息的展示方式。",
      tokenView: { compact: "紧凑", detailed: "详细" },
    },
    tools: {
      title: "工具",
    ...
    skills: {
      ...
      emptyTitle: "还没有技能",
      emptyDescription:
        "将你的 Agent Skill 文件夹放在 OntoAgent 根目录下的 `/skills/custom` 文件夹中。",
      emptyButton: "创建你的第一个技能",
    },
    notification: {
      title: "通知",
      description:
        "OntoAgent 只会在窗口不活跃时发送完成通知，特别适合长时间任务：你可以先去做别的事，完成后会收到提醒。",
