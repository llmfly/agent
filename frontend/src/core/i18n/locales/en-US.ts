...
export const enUS: Translations = {
  ...
  welcome: {
    ...
    description:
      "Welcome to OntoAgent, your AI data agent. Make data not just available, but trustworthy! With built-in and custom skills, OntoAgent helps you explore data, govern data, analyze data, and build ontologies.",

    createYourOwnSkill: "Create Your Own Skill",
    createYourOwnSkillDescription:
      "Create your own skill to release the power of OntoAgent. With customized skills,\nOntoAgent can help you search on the web, analyze data, and generate\n artifacts like slides, web pages and do almost anything.",
  },
  ...
  inputBox: {
    ...
    suggestions: [
      {
        suggestion: "Explore Data",
        prompt: "Explore data sources and generate a data profile report.",
        icon: PenLineIcon,
      },
      {
        suggestion: "Govern Data",
        prompt: "Validate and standardize data quality.",
        icon: MicroscopeIcon,
      },
      {
        suggestion: "Analyze Data",
        prompt: "Conduct deep analysis on [topic] data and summarize findings.",
        icon: ShapesIcon,
      },
      {
        suggestion: "Ontology",
        prompt: "Build a knowledge ontology model for [domain].",
  ...
  dataAssets: {
    title: "Data Assets",
    description: "Create and manage your data sources — databases, APIs, and more.",
    newDataSource: "New Data Source",
    emptyTitle: "No data sources yet",
    emptyDescription: "Connect your first data source to start exploring and analyzing data.",
    searchPlaceholder: "Search data sources...",
    filterAll: "All types",
    deleteConfirm: "Are you sure you want to delete this data source? This action cannot be undone.",
    ...
    descriptionPlaceholder: "Optional description for this data source",
    type: "Type",
    host: "Host",
    port: "Port",
    username: "Username",
    ...
    database: "Database",
    ssl: "Use SSL",
    attachedConversations: "Attached Conversations",
    attach: "Attach",
    detach: "Detach",
    alias: "Alias",
    aliasPlaceholder: "Optional alias visible to the agent",
    noAttachedConversations: "No conversations attached",
    types: {
      mysql: "MySQL",
  ...
  agents: {
    ...
    saving: "Saving agent...",
    saveRequested:
      "Save requested. OntoAgent is generating and saving an initial version now.",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "The agent was created, but OntoAgent could not load it yet. Please refresh this page in a moment.",
    more: "More actions",
  ...
  // Workspace
  workspace: {
    officialWebsite: "OntoAgent official website",
    githubTooltip: "OntoAgent on Github",
    settingsAndMore: "Settings",
    visitGithub: "OntoAgent on GitHub",
    reportIssue: "Report a issue",
    contactUs: "Contact us",
    about: "About OntoAgent",
    logout: "Log out",
  },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "Install skill and make it available to OntoAgent",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription:
      "Navigate OntoAgent faster with keyboard shortcuts.",
  ...
  settings: {
    title: "Settings",
    description: "Adjust how OntoAgent looks and behaves for you.",
    sections: {
      account: "Account",
    ...
    memory: {
      title: "Memory",
      description:
        "OntoAgent automatically learns from your conversations in the background. These memories help OntoAgent understand you better and deliver a more personalized experience.",
    ...
    appearance: {
      ...
      tokenDescription: "Control how token usage information is displayed in conversations.",
      tokenView: { compact: "Compact", detailed: "Detailed" },
    },
    tools: {
      title: "Tools",
    ...
    skills: {
      ...
      emptyDescription:
        "Put your agent skill folders under the `/skills/custom` folder under the root folder of OntoAgent.",
      emptyButton: "Create Your First Skill",
    },
    notification: {
      title: "Notification",
      description:
        "OntoAgent only sends a completion notification when the window is not active. This is especially useful for long-running tasks so you can switch to other work and get notified when done.",
